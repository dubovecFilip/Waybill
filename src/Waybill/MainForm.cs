...
public partial class MainForm : Form {
    ...
    private void FillSessionSide() {
        ...
        _sessionSide.Controls.Add(new Label {
            Dock = DockStyle.Top, Height = 26, Text = Strings.T("sess.inThisOne").ToUpperInvariant(),
            ForeColor = Look.Dim, BackColor = Look.Panel, Font = Look.Label, Padding = new Padding(14, 8, 0, 0),
        });
