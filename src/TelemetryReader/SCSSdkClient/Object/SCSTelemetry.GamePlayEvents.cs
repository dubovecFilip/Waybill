    ...
    public partial class SCSTelemetry {
        ...
        public class GamePlayEvents {
            ...
            public class Delivered {
                ...
                // Computed, not real data - deriving it during deserialization (before
                // Finished/DeliveryTime are necessarily populated yet) throws a
                // NullReferenceException from inside Time's operator-, so it must stay
                // out of the JSON contract entirely. Recompute it from Finished and
                // DeliveryTime after deserializing instead of reading this property.
                [JsonIgnore]
